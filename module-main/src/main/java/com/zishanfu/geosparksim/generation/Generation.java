...
public class Generation {
    ...
    /**
     * Generate vehicle list. The vehicle source and destination randomly generated by the boundary
     * and travel length.
     *
     ...
     * @param graph the road network graph with routing index
     ...
     */
    public Vehicle[] vehicleGeneration(
            double minLon,
            double minLat,
            double maxLon,
            double maxLat,
        ...
        SpatialRandom spatialRand =
                new SpatialRandom(minLon, minLat, maxLon, maxLat, maxLen, graph);
